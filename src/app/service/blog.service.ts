...
export class BlogService {
  ...
  editBlog(blog: Blog) {
    const indexNumber = this.blogs.findIndex(o => o.id = blog.id);
    this.blogs[indexNumber].title = blog.title;
    this.blogs[indexNumber].description = blog.description;
    this.blogs[indexNumber].imgUrl = blog.imgUrl;
    console.log(this.blogs);
  }

  getBlogs(): Observable<Blog[]> {
    return this.http.get<Blog[]>('https://run.mocky.io/v3/40d1dd50-1cc9-42b0-afdd-0d75c7186fe3').pipe(catchError(this.handleError));
  }
